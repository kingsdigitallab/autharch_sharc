...
# autharch_sharc/
APPS_DIR = ROOT_DIR / "autharch_sharc"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "autharch_sharc.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "autharch_sharc.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""King's Digital Lab""", "kings-digital-lab@autharch_sharc.info")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "autharch_sharc.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "autharch_sharc.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
